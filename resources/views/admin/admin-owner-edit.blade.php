...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('admin.owners.update', $owner->id) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" placeholder="Masukkan nama lengkap" value="{{ old('name', $owner->name) }}" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" class="form-control" placeholder="contoh@email.com" value="{{ old('email', $owner->email) }}" required>
            @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>

        {{-- Jika Anda ingin mengizinkan perubahan password, tambahkan di sini --}}
        {{--
        <div class="form-group">
